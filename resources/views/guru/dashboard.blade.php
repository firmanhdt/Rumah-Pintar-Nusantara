        ...
        <div class="relative">
            ...
            <div id="sidebar" class="w-full md:w-64 bg-white min-h-screen transition-all duration-300 overflow-hidden fixed md:relative z-40">
                ...
                <div class="px-4">
                    ...
                    <!-- Navigation -->
                    <nav class="space-y-1">
                        <a href="{{ url('/guru/dashboard') }}" class="flex items-center px-4 py-2 text-white bg-[#49BBBD] hover:text-gray-700 rounded-md">
        ...
        <div class="flex-1 p-8">
            ...
            <div class="max-w-4xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                <div class="bg-white p-6 rounded-lg shadow-sm flex items-center space-x-4">
                    <div class="bg-[#82CD47] p-4 rounded-lg">
                    ...
                    <div>
                        ...
                        <div class="text-2xl font-semibold">{{$tasks->count()}}</div>
                    </div>
                </div>

                <!-- Materi -->
                <div class="bg-white p-6 rounded-lg shadow-sm flex items-center space-x-4">
                    <div class="bg-[#F7B731] p-4 rounded-lg">
                        <svg class="w-8 h-8 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 6.253v13m0-13C10.832 5.477 9.246 5 7.5 5S4.168 5.477 3 6.253v13C4.168 18.477 5.754 18 7.5 18s3.332.477 4.5 1.253m0-13C13.168 5.477 14.754 5 16.5 5c1.747 0 3.332.477 4.5 1.253v13C19.832 18.477 18.247 18 16.5 18c-1.746 0-3.332.477-4.5 1.253"/>
                        </svg>
                    </div>
                    <div>
                        <div class="text-gray-500">Materi</div>
                        <div class="text-2xl font-semibold">{{$materials->count()}}</div>
                    </div>
                </div>
            </div>
        </div>
